...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    CartController _cartCotroller = Get.find();
    // List<Cart> items = [
    //   Cart(
    //     productId: 1,
    //       price: 10.0,
    ...
    List<Cart> items = _cartCotroller.listOrder;
      ...
      children: [
                ...
                Expanded(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          "${NumberFormat.currency(locale: 'vi').format(items[index].product.price)}",
                          style: TextStyle(
                              fontSize: 15,
        ...
        Padding(
            ...
            child: ListTile(
                ...
                trailing: voucher.voucherName == null
                    ? Text(
                        'Chọn mã giảm giá',
                      )
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                '${NumberFormat.currency(locale: 'vi').format(500000)}',
                style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.w600,
                    color: Colors.black),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  '-${NumberFormat.currency(locale: 'vi').format(voucher.voucherValue)}',
                  style: TextStyle(
                      fontSize: 17,
                      fontWeight: FontWeight.w600,
                      color: Colors.red),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                '${NumberFormat.currency(locale: 'vi').format(530000)}',
                style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.w600,
                    color: Colors.red),
