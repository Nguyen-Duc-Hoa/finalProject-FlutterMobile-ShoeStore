...
class OrderDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (order.status == 0)
      ...
      status = 'Đã hủy';
    Query<Map<String, dynamic>> orderItem = FirebaseFirestore.instance
        .collection('orderItem')
        .where('orderId', isEqualTo: order.id);
    Query<Map<String, dynamic>> orderTracking = FirebaseFirestore.instance
          ...
          onSubmitted: (response) async {
            ...
            FirebaseFirestore.instance
              ...
              value.docs[0].reference
                  .update({'rate': num.parse(newrating.toStringAsFixed(1))});
            });
            FirebaseFirestore.instance
                .collection('ranking')
              ...
              if (response.comment == '')
                value.docs[0].reference
                    .update({'score': value.docs[0].get('score') + 3});
              else
                value.docs[0].reference
                    .update({'score': value.docs[0].get('score') + 5});
            });
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                      ...
                      child: Text(
                        'Đơn hàng ${status} \nMã đơn hàng: ${order.id} \nNgày đặt hàng: ${order.orderDate.toString().substring(0, order.orderDate.toString().lastIndexOf(":"))}',
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 15,
                    ...
                    builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                      ...
                      return Container(
                        ...
                        child: Padding(
                          ...
                          child: ListTile(
                              onTap: () {
                                Get.to(Order_tracking(orderId: order.id));
                              },
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${tracking.note}',
                                    style: TextStyle(
                                        color: Color(0xFF27AA69), fontSize: 15),
                                  ),
                                  SizedBox(
                                    height: 5,
                                  ),
                                  Text(
                                      '${tracking.time.toString().substring(0, tracking.time.toString().lastIndexOf(":"))}')
                                ],
                              )),
                        ),
                      );
                            ...
                            Expanded(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      "${NumberFormat.currency(locale: 'vi').format(items[index].price)}",
                                      style: TextStyle(
                                          fontSize: 15,
                            ...
                            child: FlatButton(
                              onPressed: () {
                                _showRatingAppDialog(
                                    items[index].productId, snapshot, index);
                              },
                              child: Container(
                                decoration: BoxDecoration(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${NumberFormat.currency(locale: 'vi').format(order.total - order.voucherValue)}',
                        style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                            color: Colors.red),
